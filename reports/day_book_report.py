...
st.title("📒 Day Book Report")
st.markdown("### Date wise complete transaction book")
...
c1, c2 = st.columns(2)
c1.info(f"📌 Total Entries\n\n{summary['total_entries']}")
c2.success(f"💰 Total Amount\n\n₹ {summary['total_amount']:,.2f}")
...
st.markdown("### 📌 Day Book Transactions")
...
st.markdown("### 📌 Day Book Transactions (Date Wise)")
...
# ----------------------------------------
st.markdown("---")
st.markdown("## 📅 Daily Summary (Date Wise Totals)")
...
# Daily Chart
# ----------------------------------------
st.markdown("### 📊 Daily Total Amount Trend")
...
# ----------------------------------------
st.markdown("---")
st.markdown("## 🔻 Top 10 Debit Accounts (Most Payments Gone)")
...
# ----------------------------------------
st.markdown("---")
st.markdown("## 🔺 Top 10 Credit Accounts (Most Receipts Came)")
...
# ----------------------------------------
st.markdown("---")
st.markdown("## 🥧 Top 5 Accounts Pie Chart (Others Combined)")
